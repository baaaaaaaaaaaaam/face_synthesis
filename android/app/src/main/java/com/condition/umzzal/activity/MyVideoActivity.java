...
public class MyVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setVideoPath(MYURL.FINISH_VIDEO_URL+member_nickname+day+".mp4");
        ...
        download_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) { // 다운로드 버튼 클릭시 이벤트
               ...
               // if (! path.exists())  path.mkdirs();
                ...
                downloadTask.execute(MYURL.FINISH_VIDEO_URL+member_nickname+day+".mp4");
            }
        });
            ...
            try {
             ...
             //   if (! path.exists())  path.mkdirs();
              ...
              //  Log.i("aaaa2",path.getPath());
                 ...
                 path= Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);
                outputFile= new File("/storage/emulated/0/DCIM/Camera/", timeToString(Calendar.getInstance())+".avi"); //파일명까지 포함함 경로의 File 객체 생성
